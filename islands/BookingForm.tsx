...
export function BookingForm(props: Props) {
    ...
    return (
        ...
        <section class="w-[95%] m-auto flex justify-center">
            <form  class="w-full max-w-lg" onSubmit={bookAppointment}>
                ...
                <div class="flex items-center -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input name="number" required pattern="[0-9]{10}" class="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="number" placeholder="mobile number" />
                    </div>
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input name="email" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="email"  placeholder="Enter your email" />
                    </div>
                </div>
